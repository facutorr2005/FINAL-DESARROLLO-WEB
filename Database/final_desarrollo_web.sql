...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-05-2026 a las 05:07:58
...
--
-- Estructura de tabla para la tabla `estados_roles_usuarios`
--

CREATE TABLE `estados_roles_usuarios` (
  `id` tinyint(4) NOT NULL,
  `nombre_estado` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `estados_roles_usuarios`
--

INSERT INTO `estados_roles_usuarios` (`id`, `nombre_estado`) VALUES
(1, 'rol_activo'),
(2, 'rol_inactivo');
...
CREATE TABLE `productos` (
  ...
  `editado_por` int(11) DEFAULT NULL,
  `dado_de_baja_por` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indices de la tabla `estados_roles_usuarios`
--
ALTER TABLE `estados_roles_usuarios`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `listas`
  ...
  ADD KEY `fk_listas_editado_por` (`editado_por`);
...
ALTER TABLE `productos`
  ...
  ADD KEY `fk_productos_editado_por` (`editado_por`),
  ADD KEY `fk_productos_dado_de_baja_por` (`dado_de_baja_por`);
...
ALTER TABLE `usuarios`
  ...
  ADD KEY `fk_usuarios_editado_por` (`editado_por`),
  ADD KEY `fk_usuarios_dado_de_baja_por` (`dado_de_baja_por`);
...
ALTER TABLE `usuarios_roles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_ur_usuario` (`id_usuario`),
  ADD KEY `fk_ur_rol` (`id_rol`),
  ADD KEY `fk_ur_estado` (`id_estado`);
...
--
-- AUTO_INCREMENT de la tabla `estados_roles_usuarios`
--
ALTER TABLE `estados_roles_usuarios`
...
--
ALTER TABLE `listas`
  ADD CONSTRAINT `fk_listas_editado_por` FOREIGN KEY (`editado_por`) REFERENCES `usuarios` (`id`),
...
ALTER TABLE `productos`
  ...
  ADD CONSTRAINT `fk_productos_creado_por` FOREIGN KEY (`creado_por`) REFERENCES `usuarios` (`id`),
  ADD CONSTRAINT `fk_productos_dado_de_baja_por` FOREIGN KEY (`dado_de_baja_por`) REFERENCES `usuarios` (`id`),
  ADD CONSTRAINT `fk_productos_editado_por` FOREIGN KEY (`editado_por`) REFERENCES `usuarios` (`id`),
...
ALTER TABLE `usuarios`
  ...
  ADD CONSTRAINT `fk_usuarios_creado_por` FOREIGN KEY (`creado_por`) REFERENCES `usuarios` (`id`),
  ADD CONSTRAINT `fk_usuarios_dado_de_baja_por` FOREIGN KEY (`dado_de_baja_por`) REFERENCES `usuarios` (`id`),
  ADD CONSTRAINT `fk_usuarios_editado_por` FOREIGN KEY (`editado_por`) REFERENCES `usuarios` (`id`);

--
-- Filtros para la tabla `usuarios_roles`
--
ALTER TABLE `usuarios_roles`
  ADD CONSTRAINT `fk_ur_estado` FOREIGN KEY (`id_estado`) REFERENCES `estados_roles_usuarios` (`id`),
  ADD CONSTRAINT `fk_ur_rol` FOREIGN KEY (`id_rol`) REFERENCES `roles` (`id`),
  ADD CONSTRAINT `fk_ur_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`);
COMMIT;
